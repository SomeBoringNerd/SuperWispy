= This branch is up-to-date with Aywen's episode 3 video. For an updated build of the game with english translation and QOL features, check out the main branch
